...
{
   if($GPGT::MPDebug) echo("\c5 ====> LOAD-SERVER gpgt/server/game.cs: " SPC "onServerCreated()" );
...
{
   if($GPGT::MPDebug) echo("\c9 ====> PURGE gpgt/server/scripts/game.cs: " SPC "onServerDestroyed()" );
...
{
   if($GPGT::MPDebug) echo("\c5 ====> GAME gpgt/server/scripts/game.cs: " SPC "onMissionLoaded()" );
...
{
   if($GPGT::MPDebug) echo("\c5 ====> GAME gpgt/server/scripts/game.cs: " SPC "onMissionEnded()" );
...
function startGame()
{
   if($GPGT::MPDebug) echo("\c5 ====> GAME gpgt/server/scripts/game.cs: " SPC "startGame()" );
...
function endGame()
{
   if($GPGT::MPDebug) echo("\c9 ====> PURGE gpgt/server/scripts/game.cs: " SPC "endGame()" );
...
{
   if($GPGT::MPDebug) echo("\c5 ====> GAME gpgt/server/scripts/game.cs: " SPC "GameConnection::onClientEnterGame(" SPC %this SPC ")" );
...
{
   if($GPGT::MPDebug) echo("\c9 ====> PURGE gpgt/server/scripts/game.cs: " SPC "GameConnection::onClientLeaveGame(" SPC %this SPC ")" );
...
{
   if($GPGT::MPDebug) echo("\c5 ====> GAME gpgt/server/scripts/game.cs: " SPC "GameConnection::onLeaveMissionArea(" SPC %this SPC ")" );
...
{
   if($GPGT::MPDebug) echo("\c5 ====> GAME gpgt/server/scripts/game.cs: " SPC "GameConnection::onEnterMissionArea(" SPC %this SPC ")" );
...
{
   if($GPGT::MPDebug) echo("\c5 ====> GAME gpgt/server/scripts/game.cs: " SPC "GameConnection::createPlayer(" SPC %this SPC "," SPC %spawnPoint SPC ")" );
   ...
   //EFM
   //GPGT - These hacks are only good for single player testing/games
   $GPGT::SP_Client = %this;
   $GPGT::SP_Camera = %this.camera;
   $GPGT::SP_Player = %this.player;
}
