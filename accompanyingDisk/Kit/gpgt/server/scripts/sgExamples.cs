...
addMaterialMapping("Wall_filler101m" , "detail: gpgt/data/interiors/lightingPack/wall_detail"); 
...
datablock DecalData(GlowDecal)
{
   sizeX       = 2;
   sizeY       = 2;
   textureName = "gpgt/data/shapes/lightingPack/Arrow";
...
{
  animateTexture = "0";
  animTexName[0] = "gpgt/data/shapes/particles/smoke";
  ...
  spinRandomMin = "-100";
  spinSpeed = "0.29";
  textureName = "gpgt/data/shapes/particles/smoke";
  times[0] = "0";
  times[1] = "0.49";
  times[2] = "1";
  times[3] = "1";
