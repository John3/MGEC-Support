...
{
   if($GPGT::MPDebug) echo("\c7 ====> LOAD-CLIENT /gpgt/client/scripts/serverConnection.cs ->:" SPC "GameConnection::initialControlSet(" SPC %this SPC ")");
...
{
   if($GPGT::MPDebug) echo("\c6 ====> CONNECT /gpgt/client/scripts/serverConnection.cs ->:" SPC "GameConnection::onConnectionAccepted(" SPC %this SPC ")");
...
{
   if($GPGT::MPDebug) echo("\c6 ====> CONNECT /gpgt/client/scripts/serverConnection.cs ->:" SPC "GameConnection::onConnectionTimedOut(" SPC %this SPC ")");
...
{
   if($GPGT::MPDebug) echo("\c6 ====> CONNECT /gpgt/client/scripts/serverConnection.cs ->:" SPC "GameConnection::onConnectionDropped(" SPC %this SPC "," SPC %msg SPC ")");
...
{
   if($GPGT::MPDebug) echo("\c6 ====> CONNECT /gpgt/client/scripts/serverConnection.cs ->:" SPC "GameConnection::onConnectionError(" SPC %this SPC "," SPC %msg SPC ")");
...
{
   if($GPGT::MPDebug) echo("\c6 ====> CONNECT /gpgt/client/scripts/serverConnection.cs ->:" SPC "GameConnection::onConnectRequestRejected(" SPC %this SPC "," SPC %msg SPC ")");
...
{
   if($GPGT::MPDebug) echo("\c6 ====> CONNECT /gpgt/client/scripts/serverConnection.cs ->:" SPC "GameConnection::onConnectRequestTimedOut(" SPC %this SPC ")");
...
function disconnect()
{
   if($GPGT::MPDebug) echo("\c6 ====> CONNECT /gpgt/client/scripts/serverConnection.cs ->:" SPC "disconnect()");
...
{
   if($GPGT::MPDebug) echo("\c6 ====> CONNECT /gpgt/client/scripts/serverConnection.cs ->:" SPC "disconnectedCleanup()");
