...
{
   if($GPGT::MPDebug) echo("\c6 ====> CONNECT /common/server/clientConnection.cs ->:" SPC "GameConnection::onConnectRequest(" SPC %client SPC "," SPC %netAddress SPC "," SPC %name SPC ")" );
...
{
   if($GPGT::MPDebug) echo("\c6 ====> CONNECT /common/server/clientConnection.cs ->:" SPC "GameConnection::onConnect(" SPC %client SPC "," SPC %name SPC ")" );
...
{
   if($GPGT::MPDebug) echo("\c6 ====> CONNECT /common/server/clientConnection.cs ->:" SPC "GameConnection::setPlayerName(" SPC %client SPC "," SPC %name SPC ")" );
...
{
   echo("\c6 ====> CONNECT /common/server/clientConnection.cs ->:" SPC "GameConnection::onDrop(" SPC %client SPC "," SPC %reason SPC ")" );
...
{
   if($GPGT::MPDebug) echo("\c9 ====> GAME /common/server/clientConnection.cs ->:" SPC "GameConnection::startMission(" SPC %client SPC ")" );
...
{
   if($GPGT::MPDebug) echo("\c9 ====> GAME /common/server/clientConnection.cs ->:" SPC "GameConnection::endMission(" SPC %this SPC ")");
