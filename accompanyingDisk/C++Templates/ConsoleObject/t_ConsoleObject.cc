...
#include "t_ConsoleObject.h"

//-----------------------------------------------------------------------------
IMPLEMENT_CONOBJECT( t_ConsoleObject );

//-----------------------------------------------------------------------------
t_ConsoleObject::t_ConsoleObject()
{
}
//-----------------------------------------------------------------------------
t_ConsoleObject::~t_ConsoleObject()
...
//-----------------------------------------------------------------------------
void t_ConsoleObject::initPersistFields()
{
...
//-----------------------------------------------------------------------------
void t_ConsoleObject::consoleInit()
{
